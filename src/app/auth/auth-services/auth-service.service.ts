...
public getOneUser(id:number):Observable<UserDTO>{
...
public registerUser(body:UserDTO):Observable<UserDTO>{
...
public logUser(body:UserDTO):Observable<UserDTO>{
...
public editUser(id:number, body:UserDTO):Observable<any>{
